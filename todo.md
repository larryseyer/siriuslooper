...
- What was deferred:
  1. **RME-style mono/stereo split/collapse toggle.** Engine source model supports both (setChannelInputSource stereo flag); the UI toggle that splits a stereo strip into two mono-source strips and collapses back is not built. Default is stereo strips.
