# Larry Seyer Acoustic Drum Library License
...
3. **Personal Use**: You may use the Sample Library for personal, non-commercial
   music creation.

### Prohibited Uses

1. **No Redistribution**: You may NOT redistribute, share, upload, or transfer
   the Sample Library files (FLAC audio files and SFZ mapping files) to any
   third party, whether for free or for sale.

2. **No Repackaging**: You may NOT repackage, resample, or include the raw
   sample files in any sample library, sound pack, instrument, or similar
   product.
...
The Sample Library remains the exclusive property of Larry Seyer. This license
does not grant you any ownership rights to the samples themselves.
...
This license is effective until terminated. It will terminate automatically if
you fail to comply with any term of this license. Upon termination, you must
destroy all copies of the Sample Library in your possession.

---

## Disclaimer

THE SAMPLE LIBRARY IS PROVIDED "AS IS" WITHOUT WARRANTY OF ANY KIND, EXPRESS OR
