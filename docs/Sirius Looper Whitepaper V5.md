...
V5 is a substantive revision pass. The architecture is unchanged; what's new is rigor about what the architecture *guarantees* and what happens when reality intrudes.
...
*End of Sirius Looper Whitepaper V5. Comments, criticism, and contributions welcome.*
