...
Append to `tests/ConstituentStateTests.cpp` (add `#include "sirius/RenderPipeline.h"` and `#include "sirius/TempoMap.h"` to the includes, and `using ida::RenderPipeline;`):
