#!/bin/bash
# Ralph Wiggum - Long-running AI agent loop for IDA.
...
# the IDA codebase plus headroom for adapter implementation + tests.
...
echo "Starting Ralph (IDA) - Max iterations: $MAX_ITERATIONS"
